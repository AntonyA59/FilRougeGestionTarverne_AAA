...
public class ShopController {
     ...
     * @throws EntityNotFoundException exception if the id manager or ingredient is not in the database
    ...
    public ManagerDto byingIngredient(@RequestBody ShopIngredientDto shopIngredientDto){
        try {
            return shopService.prepareIngredientAndBuy(shopIngredientDto.getIdManager(),shopIngredientDto.getIdIngredient());
    ...
    public ManagerDto sellingIngredient(@RequestBody ShopIngredientDto shopIngredientDto){
        try {
            return shopService.prepareIngredientAndSell(shopIngredientDto.getIdManager(),shopIngredientDto.getIdIngredient());
