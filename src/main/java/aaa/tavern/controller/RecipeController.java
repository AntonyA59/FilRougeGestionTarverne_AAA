...
public class RecipeController {
     ...
     * 
     * @param managerId  id manager who wants to launch the preparation of the
     *                   recipe
    ...
    public ResponseEntity<String> requestRecipe(@RequestParam int managerId, @RequestParam int recipeId,
